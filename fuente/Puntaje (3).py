...
canvas = Canvas(ventana, width=ventana.winfo_screenwidth(), height=ventana.winfo_screenheight())
canvas.pack(side="top", fill="both", expand=True)
canvas.create_image(0, 0, image=imagen_tk, anchor="nw")


# Crear el marco (frame) para el recuadro
marco = Frame(ventana, bg="#CDFFF6", width=550, height=340)
marco.pack(pady=10)
...
texto = Label(text="Tu puntaje es: 1000\nTiempo restante: 5 segundos\nCartas acertadas: 10\nIntentos fallidos: 1", font=("Arial", 28), bg="#CDFFF6", fg="blue")
texto.place(relx=0.5, rely=0.4, anchor="center")

# Crear el botón "Continuar"
boton = Button(text="Continuar", font=fuente_boton, bg="#89E97F", fg="#FFFFFF", command=lambda: print("Botón presionado"))
